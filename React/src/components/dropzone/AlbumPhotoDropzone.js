...
function Basic({ uploadText, uploadTextClass, iconClass, iconSize, activeStyle, acceptStyle, onDrop }) {
    ...
    return (
        <Container {...getRootProps({ style: isHovered ? hoveredStyle : style })} onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
            <input {...getInputProps()} />
                    ...
                    backgroundImage ? (
                        ...
                        <>
                            <Container
                                // rounded
                                // src={"https://via.placeholder.com/150"}
                                style={{ width: '150px', height: '150px', objectFit: 'cover', borderRadius: '2%', backgroundColor: '#4b4b4b'}}
                            >
                                <Row className='h-100 d-flex text-center align-items-center'>
                                    {uploadText}
                                </Row>
                            </Container>
                        </>
...
const AlbumPhotoDropzone = ({ uploadText, uploadTextClass, iconClass, iconSize, activeStyle, acceptStyle, onDrop }) => (
...
export default AlbumPhotoDropzone;